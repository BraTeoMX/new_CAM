<div class="flex flex-col col-span-full sm:col-span-6 xl:col-span-4 bg-white dark:bg-gray-800 shadow-sm rounded-xl">
    <div class="px-5 pt-5">
        ...
        <div class="flex items-start">
            <div class="text-3xl font-bold text-gray-800 dark:text-gray-100 mr-2">$<?php echo e(number_format($dataFeed->sumDataSet(1, 1), 0)); ?></div>
...
<?php /**PATH C:\xampp8.2\htdocs\Proyecto-CAM\resources\views/components/dashboard/dashboard-card-01.blade.php ENDPATH**/ ?>