  ...
  function() {
    ...
    Dropdown2.prototype.show = function() {
      ...
      this._popperInstance.setOptions(function(options) {
        return __assign4(__assign4({}, options), { modifiers: __spreadArray(__spreadArray([], options.modifiers, true), [
  ...
  document.querySelectorAll("[data-dropdown-toggle]").forEach(function($triggerEl) {
    ...
    if ($dropdownEl) {
      ...
      new Dropdown($dropdownEl, $triggerEl, {
        placement: placement ? placement : Default4.placement,
        triggerType: triggerType ? triggerType : Default4.triggerType,
        offsetSkidding: offsetSkidding ? parseInt(offsetSkidding) : Default4.offsetSkidding,
        offsetDistance: offsetDistance ? parseInt(offsetDistance) : Default4.offsetDistance,
        delay: delay ? parseInt(delay) : Default4.delay,
        ignoreClickOutsideClass: ignoreClickOutsideClass ? ignoreClickOutsideClass : Default4.ignoreClickOutsideClass
      });
    } else {
  ...
  document.querySelectorAll("[data-modal-target]").forEach(function($triggerEl) {
    ...
    if ($modalEl) {
      ...
      new Modal($modalEl, {
        ...
        backdrop: backdrop ? backdrop : Default5.backdrop
      });
    } else {
...
function initTabs() {
  document.querySelectorAll("[data-tabs-toggle]").forEach(function($parentEl) {
    ...
    new Tabs($parentEl, tabItems, {
      defaultTabId,
      activeClasses: activeClasses ? activeClasses : Default7.activeClasses,
      inactiveClasses: inactiveClasses ? inactiveClasses : Default7.inactiveClasses
    });
  });
}
if (typeof window !== "undefined") {
...
var Tooltip = (
  ...
  function() {
    ...
    Tooltip2.prototype.show = function() {
      ...
      this._popperInstance.setOptions(function(options) {
        return __assign8(__assign8({}, options), { modifiers: __spreadArray2(__spreadArray2([], options.modifiers, true), [
          { name: "eventListeners", enabled: true }
        ], false) });
      });
      this._setupClickOutsideListener();
  ...
  document.querySelectorAll("[data-tooltip-target]").forEach(function($triggerEl) {
    ...
    if ($tooltipEl) {
      ...
      new Tooltip($tooltipEl, $triggerEl, {
        ...
        triggerType: triggerType ? triggerType : Default8.triggerType
      });
    } else {
    ...
    if ($targetEl) {
      if (!instances_default.instanceExists("CopyClipboard", $targetEl.getAttribute("id"))) {
        new CopyClipboard($triggerEl, $targetEl, {
          htmlEntities: htmlEntities && htmlEntities === "true" ? true : Default12.htmlEntities,
          contentType: contentType ? contentType : Default12.contentType
        });
      }
    } else {
  ...
  document.querySelectorAll("[datepicker], [inline-datepicker], [date-rangepicker]").forEach(function($datepickerEl) {
    if ($datepickerEl) {
      ...
      new Datepicker2($datepickerEl, {
        buttons: buttons ? buttons : Default13.buttons,
        autoSelectToday: autoselectToday ? autoselectToday : Default13.autoSelectToday,
        autohide: autohide ? autohide : Default13.autohide,
        format: format ? format : Default13.format,
        maxDate: maxDate ? maxDate : Default13.maxDate,
        minDate: minDate ? minDate : Default13.minDate,
        orientation: orientation_1 ? orientation_1 : Default13.orientation,
        title: title ? title : Default13.title,
        language: language ? language : Default13.language,
        rangePicker: rangePicker ? rangePicker : Default13.rangePicker
      });
    } else {
