document.addEventListener('DOMContentLoaded', function() {
    ...
    async function enviarFinalizacionBahia(ticketId) {
        ...
        try {
            const response = await fetch('/OrdenOT/finalizarBahia', {
                method: 'POST',
                headers: {
    ...
    async function mostrarModalFinalizarAtencion(ticketId, horaFinalizacion) {
        ...
        try {
            ...
            const [fallasResponse, causasResponse, accionesResponse] = await Promise.all([
                fetch('/OrdenOT/obtenerFallas'),
                fetch('/OrdenOT/obtenerCausas'),
                fetch('/OrdenOT/obtenerAcciones')
            ]);
    ...
    async function mostrarModalIniciarAtencion(ticketId, maquina) {
        try {
            const response = await fetch(`/OrdenOT/obtenerClasesMaquina/${encodeURIComponent(maquina)}`);
    ...
    async function enviarInicioAtencion(ticketId, datosModal) {
        ...
        try {
            const response = await fetch('/OrdenOT/iniciarAtencion', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Accept': 'application/json',
    ...
    async function enviarFinalizacionAtencion(ticketId, horaFinalizacion, datosModal, satisfaccion) {
        ...
        try {
            const response = await fetch('/OrdenOT/finalizarAtencion', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Accept': 'application/json',
    ...
    async function enviarActivacionBahia(ticketId, motivo) {
        ...
        try {
            const response = await fetch('/OrdenOT/activarBahia', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Accept': 'application/json',
