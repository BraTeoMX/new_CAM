                    ...
                    <thead
                        ...
                        <tr>
                            <th class="px-3 py-2 border-b border-gray-200 dark:border-gray-700">
                                <input type="text" name="planta" id="planta" placeholder="Planta"
                            ...
                            <th class="px-3 py-2 border-b border-gray-200 dark:border-gray-700">
                                <input type="text" name="modulo" id="modulo" placeholder="Módulo"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 placeholder-gray-400 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            </th>
                            <th class="px-3 py-2 border-b border-gray-200 dark:border-gray-700">
                            ...
                            <th class="px-3 py-2 border-b border-gray-200 dark:border-gray-700">
                                <input type="text" name="hora_paro" id="hora_paro" placeholder="dd-mm-yyyy, hh:mm:ss"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 placeholder-gray-400 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            </th>
                            <th class="px-3 py-2 border-b border-gray-200 dark:border-gray-700">
                            ...
                            <th class="px-3 py-2 border-b border-gray-200 dark:border-gray-700">
                                <input type="text" name="total_min" id="total_min" placeholder="Minutos Totales"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 placeholder-gray-400 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            </th>
                            <th class="px-3 py-2 border-b border-gray-200 dark:border-gray-700">
                            ...
                            <th class="px-3 py-2 border-b border-gray-200 dark:border-gray-700">
                                <input type="text" name="minutos_bahia" id="minutos_bahia" placeholder="Minutos Bahía"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 placeholder-gray-400 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            </th>
                            <th class="px-3 py-2 border-b border-gray-200 dark:border-gray-700">
                                <input type="text" name="id_maquina" id="id_maquina" placeholder="ID Máquina"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 placeholder-gray-400 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            </th>
                            <th class="px-3 py-2 border-b border-gray-200 dark:border-gray-700">
                                <input type="text" name="tipo_maquina" id="tipo_maquina" placeholder="Tipo Máquina"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 placeholder-gray-400 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            </th>
                            <th class="px-3 py-2 border-b border-gray-200 dark:border-gray-700">
                                <input type="text" name="mecanico" id="mecanico" placeholder="Mecánico"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 placeholder-gray-400 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            </th>
                            <th class="px-3 py-2 border-b border-gray-200 dark:border-gray-700">
                                <input type="text" name="codigo_falla" id="codigo_falla" placeholder="Código Falla"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 placeholder-gray-400 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            </th>
                            <th class="px-3 py-2 border-b border-gray-200 dark:border-gray-700">
                                <input type="text" name="causa" id="causa" placeholder="Causa"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 placeholder-gray-400 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            </th>
                            <th class="px-3 py-2 border-b border-gray-200 dark:border-gray-700">
                                <input type="text" name="accion" id="accion" placeholder="Acción"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 placeholder-gray-400 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            </th>
                            <th class="px-3 py-2 border-b border-gray-200 dark:border-gray-700">
                                <input type="text" name="encuesta" id="encuesta" placeholder="Encuesta"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 placeholder-gray-400 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            </th>
                        </tr>
                    </thead>
            ...
            <div class="p-6 text-center">
                ...
                <div class="flex flex-col sm:flex-row justify-center gap-4">
                    ...
                    <button id="download-pdf-btn"
                        ...
                        <svg class="w-7 h-7 mr-2" fill="currentColor" viewBox="0 0 20 20">
                            <path
                                d="M6 2a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V7.828a2 2 0 0 0-.586-1.414l-4.828-4.828A2 2 0 0 0 11.172 1H6zm8 0v4a2 2 0 0 0 2 2h-4V2h2zm-2 8a1 1 0 0 1 1 1v1h-2v-1a1 1 0 0 1 1-1zm-2 2h2v2h-2v-2zm-2 0h2v2H8v-2zm-2 0h2v2H6v-2z" />
                        </svg>
                        PDF
                    </button>
                </div>
