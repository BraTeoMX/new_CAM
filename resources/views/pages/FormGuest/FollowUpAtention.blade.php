    ...
    <div x-cloak x-data="{ init() { } }">
        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-8">
            <div class="mb-4 sm:mb-0">
                <h1 class="text-2xl md:text-3xl text-gray-800 dark:text-gray-100 font-bold">Seguimiento de solicitudes</h1>
            </div>
        </div>
        <!-- Selector de módulo -->
        <div class="mb-6">
            <select id="modulo-select" style="width:100%" class="select2 rounded border-gray-300 dark:bg-gray-700 dark:border-gray-600" data-placeholder="Selecciona tu módulo de atención">
