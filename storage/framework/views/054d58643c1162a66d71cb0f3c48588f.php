...
<div class="relative inline-flex" x-data="{ open: false }">
    ...
    <div
        class="origin-top-right z-10 absolute top-full left-0 right-auto min-w-56 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700/60 pt-1.5 rounded-lg shadow-lg overflow-hidden mt-1 <?php echo e($align === 'right' ? 'md:left-auto md:right-0' : 'md:left-0 md:right-auto'); ?>"                
...
</div><?php /**PATH C:\xampp8.2\htdocs\Proyecto-CAM\resources\views/components/dropdown-filter.blade.php ENDPATH**/ ?>