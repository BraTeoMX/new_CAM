...
<div class="relative inline-flex" x-data="{ open: false }">
    ...
    <div
        class="origin-top-right z-10 absolute top-full -mr-48 sm:mr-0 min-w-80 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700/60 py-1.5 rounded-lg shadow-lg overflow-hidden mt-1 <?php echo e($align === 'right' ? 'right-0' : 'left-0'); ?>"                
...
</div><?php /**PATH C:\xampp8.2\htdocs\Proyecto-CAM\resources\views/components/dropdown-notifications.blade.php ENDPATH**/ ?>