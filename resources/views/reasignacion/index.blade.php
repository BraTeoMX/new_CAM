            ...
            <div class="flex-1">
                <div class="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-md mb-6">
                    ...
                    <form id="search-form" class="grid grid-cols-1 md:grid-cols-3 gap-4 items-end">
                        <div>
                            <label for="folio-search" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Folio de OT</label>
                            <input type="text" id="folio-search" name="folio" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm dark:bg-gray-700 dark:border-gray-600 focus:ring-blue-500 focus:border-blue-500">
                        </div>
                        <div>
                            <label for="date-range-search" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Rango de Fechas</label>
                            <input type="text" id="date-range-search" name="dates" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm dark:bg-gray-700 dark:border-gray-600 focus:ring-blue-500 focus:border-blue-500" placeholder="Selecciona un rango">
                        </div>
                        <button type="submit" class="w-full md:w-auto px-4 py-2 text-white bg-blue-600 hover:bg-blue-700 rounded-md">Buscar</button>
                    </form>
                </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-xl p-6 w-full max-w-md">
            ...
            <form id="formAsignar">
                ...
                <div class="flex justify-end space-x-4 mt-6">
                    ...
                    <button type="submit" class="px-4 py-2 text-white bg-blue-600 hover:bg-blue-700 rounded-md">Guardar Asignación</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div id="modalDetalles" class="fixed inset-0 z-50 hidden items-center justify-center bg-gray-900 bg-opacity-75">
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-xl p-6 w-full max-w-lg">
            <div class="flex justify-between items-center">
                ...
                <button id="cerrar-detalles" class="text-gray-500 hover:text-gray-800 dark:hover:text-gray-200">&times;</button>
            </div>
