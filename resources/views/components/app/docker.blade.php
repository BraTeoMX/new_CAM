    ...
    <nav class="flex justify-between items-center max-w-lg mx-auto h-16 px-2 sm:px-4">
        ...
        <div class="relative flex-1 mx-1" x-data="{ open: false }">
            <button type="button"
                ...
                <span class="material-symbols-outlined w-6 h-6 mb-1 text-gray-500 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-500" style="font-size:1.5rem;">description</span>
            ...
            >
                <div class="bg-white dark:bg-gray-700 rounded shadow-lg py-2">
                    ...
                    -->
                    <a href="{{ route('FormOTMeca') }}" class="flex items-center px-4 py-2 text-xs text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-600
