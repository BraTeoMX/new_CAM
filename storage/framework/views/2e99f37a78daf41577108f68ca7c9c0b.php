<div class="min-w-fit">
    ...
    <div
        id="sidebar"
        class="flex lg:!flex flex-col absolute z-40 left-0 top-0 lg:static lg:left-auto lg:top-auto lg:translate-x-0 h-[100dvh] overflow-y-scroll lg:overflow-y-auto no-scrollbar w-64 lg:w-20 lg:sidebar-expanded:!w-64 2xl:!w-64 shrink-0 bg-white dark:bg-gray-800 p-4 transition-all duration-200 ease-in-out <?php echo e($variant === 'v2' ? 'border-r border-gray-200 dark:border-gray-700/60' : 'rounded-r-2xl shadow-sm'); ?>"
                ...
                <ul class="mt-3">
                    ...
                    <li class="pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-[linear-gradient(135deg,var(--tw-gradient-stops))] <?php if(in_array(Request::segment(1), ['ecommerce'])): ?><?php echo e('from-violet-500/[0.12] dark:from-violet-500/[0.24] to-violet-500/[0.04]'); ?><?php endif; ?>" x-data="{ open: <?php echo e(in_array(Request::segment(1), ['ecommerce']) ? 1 : 0); ?> }">
                        <a class="block text-gray-800 dark:text-gray-100 truncate transition <?php if(!in_array(Request::segment(1), ['ecommerce'])): ?><?php echo e('hover:text-gray-900 dark:hover:text-white'); ?><?php endif; ?>" href="#0" @click.prevent="open = !open; sidebarExpanded = true">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    <svg class="shrink-0 fill-current <?php if(in_array(Request::segment(1), ['ecommerce'])): ?><?php echo e('text-violet-500'); ?><?php else: ?><?php echo e('text-gray-400 dark:text-gray-500'); ?><?php endif; ?>" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                                ...
                                <!-- Icon -->
                                <div class="flex shrink-0 ml-2 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                                    <svg class="w-3 h-3 shrink-0 ml-1 fill-current text-gray-400 dark:text-gray-500 <?php if(in_array(Request::segment(1), ['ecommerce'])): ?><?php echo e('rotate-180'); ?><?php endif; ?>" :class="open ? 'rotate-180' : 'rotate-0'" viewBox="0 0 12 12">
                                        <path d="M5.9 11.4L.5 6l1.4-1.4 4 4 4-4L11.3 6z" />
                                    </svg>
                                </div>
                            </div>
                    ...
                    <!-- Community -->
                    <li class="pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-[linear-gradient(135deg,var(--tw-gradient-stops))] <?php if(in_array(Request::segment(1), ['community'])): ?><?php echo e('from-violet-500/[0.12] dark:from-violet-500/[0.24] to-violet-500/[0.04]'); ?><?php endif; ?>" x-data="{ open: <?php echo e(in_array(Request::segment(1), ['community']) ? 1 : 0); ?> }">
                        <a class="block text-gray-800 dark:text-gray-100 truncate transition <?php if(!in_array(Request::segment(1), ['community'])): ?><?php echo e('hover:text-gray-900 dark:hover:text-white'); ?><?php endif; ?>" href="#0" @click.prevent="open = !open; sidebarExpanded = true">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    <svg class="shrink-0 fill-current <?php if(in_array(Request::segment(1), ['community'])): ?><?php echo e('text-violet-500'); ?><?php else: ?><?php echo e('text-gray-400 dark:text-gray-500'); ?><?php endif; ?>" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                                ...
                                <!-- Icon -->
                                <div class="flex shrink-0 ml-2 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                                    <svg class="w-3 h-3 shrink-0 ml-1 fill-current text-gray-400 dark:text-gray-500 <?php if(in_array(Request::segment(1), ['community'])): ?><?php echo e('rotate-180'); ?><?php endif; ?>" :class="open ? 'rotate-180' : 'rotate-0'" viewBox="0 0 12 12">
                                        <path d="M5.9 11.4L.5 6l1.4-1.4 4 4 4-4L11.3 6z" />
                                    </svg>
                                </div>
                            </div>
                    ...
                    <!-- Finance -->
                    <li class="pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-[linear-gradient(135deg,var(--tw-gradient-stops))] <?php if(in_array(Request::segment(1), ['finance'])): ?><?php echo e('from-violet-500/[0.12] dark:from-violet-500/[0.24] to-violet-500/[0.04]'); ?><?php endif; ?>" x-data="{ open: <?php echo e(in_array(Request::segment(1), ['finance']) ? 1 : 0); ?> }">
                        <a class="block text-gray-800 dark:text-gray-100 truncate transition <?php if(!in_array(Request::segment(1), ['finance'])): ?><?php echo e('hover:text-gray-900 dark:hover:text-white'); ?><?php endif; ?>" href="#0" @click.prevent="open = !open; sidebarExpanded = true">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    <svg class="shrink-0 fill-current <?php if(in_array(Request::segment(1), ['finance'])): ?><?php echo e('text-violet-500'); ?><?php else: ?><?php echo e('text-gray-400 dark:text-gray-500'); ?><?php endif; ?>" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                                ...
                                <!-- Icon -->
                                <div class="flex shrink-0 ml-2 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                                    <svg class="w-3 h-3 shrink-0 ml-1 fill-current text-gray-400 dark:text-gray-500 <?php if(in_array(Request::segment(1), ['finance'])): ?><?php echo e('rotate-180'); ?><?php endif; ?>" :class="open ? 'rotate-180' : 'rotate-0'" viewBox="0 0 12 12">
                                        <path d="M5.9 11.4L.5 6l1.4-1.4 4 4 4-4L11.3 6z" />
                                    </svg>
                                </div>
                            </div>
                    ...
                    <!-- Job Board -->
                    <li class="pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-[linear-gradient(135deg,var(--tw-gradient-stops))] <?php if(in_array(Request::segment(1), ['job'])): ?><?php echo e('from-violet-500/[0.12] dark:from-violet-500/[0.24] to-violet-500/[0.04]'); ?><?php endif; ?>" x-data="{ open: <?php echo e(in_array(Request::segment(1), ['job']) ? 1 : 0); ?> }">
                        <a class="block text-gray-800 dark:text-gray-100 truncate transition <?php if(!in_array(Request::segment(1), ['job'])): ?><?php echo e('hover:text-gray-900 dark:hover:text-white'); ?><?php endif; ?>" href="#0" @click.prevent="open = !open; sidebarExpanded = true">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    <svg class="shrink-0 fill-current <?php if(in_array(Request::segment(1), ['job'])): ?><?php echo e('text-violet-500'); ?><?php else: ?><?php echo e('text-gray-400 dark:text-gray-500'); ?><?php endif; ?>" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                                ...
                                <!-- Icon -->
                                <div class="flex shrink-0 ml-2 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                                    <svg class="w-3 h-3 shrink-0 ml-1 fill-current text-gray-400 dark:text-gray-500 <?php if(in_array(Request::segment(1), ['job'])): ?><?php echo e('rotate-180'); ?><?php endif; ?>" :class="open ? 'rotate-180' : 'rotate-0'" viewBox="0 0 12 12">
                                        <path d="M5.9 11.4L.5 6l1.4-1.4 4 4 4-4L11.3 6z" />
                                    </svg>
                                </div>
                            </div>
                    ...
                    <!-- Tasks -->
                    <li class="pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-[linear-gradient(135deg,var(--tw-gradient-stops))] <?php if(in_array(Request::segment(1), ['tasks'])): ?><?php echo e('from-violet-500/[0.12] dark:from-violet-500/[0.24] to-violet-500/[0.04]'); ?><?php endif; ?>" x-data="{ open: <?php echo e(in_array(Request::segment(1), ['tasks']) ? 1 : 0); ?> }">
                        <a class="block text-gray-800 dark:text-gray-100 truncate transition <?php if(!in_array(Request::segment(1), ['tasks'])): ?><?php echo e('hover:text-gray-900 dark:hover:text-white'); ?><?php endif; ?>" href="#0" @click.prevent="open = !open; sidebarExpanded = true">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                ...
                                <!-- Icon -->
                                <div class="flex shrink-0 ml-2 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                                    <svg class="w-3 h-3 shrink-0 ml-1 fill-current text-gray-400 dark:text-gray-500 <?php if(in_array(Request::segment(1), ['tasks'])): ?><?php echo e('rotate-180'); ?><?php endif; ?>" :class="open ? 'rotate-180' : 'rotate-0'" viewBox="0 0 12 12">
                                        <path d="M5.9 11.4L.5 6l1.4-1.4 4 4 4-4L11.3 6z" />
                                    </svg>
                                </div>
                            </div>
                    ...
                    <!-- Settings -->
                    <li class="pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-[linear-gradient(135deg,var(--tw-gradient-stops))] <?php if(in_array(Request::segment(1), ['settings'])): ?><?php echo e('from-violet-500/[0.12] dark:from-violet-500/[0.24] to-violet-500/[0.04]'); ?><?php endif; ?>" x-data="{ open: <?php echo e(in_array(Request::segment(1), ['settings']) ? 1 : 0); ?> }">
                        <a class="block text-gray-800 dark:text-gray-100 truncate transition <?php if(!in_array(Request::segment(1), ['settings'])): ?><?php echo e('hover:text-gray-900 dark:hover:text-white'); ?><?php endif; ?>" href="#0" @click.prevent="open = !open; sidebarExpanded = true">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    <svg class="shrink-0 fill-current <?php if(in_array(Request::segment(1), ['settings'])): ?><?php echo e('text-violet-500'); ?><?php else: ?><?php echo e('text-gray-400 dark:text-gray-500'); ?><?php endif; ?>" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                                ...
                                <!-- Icon -->
                                <div class="flex shrink-0 ml-2 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                                    <svg class="w-3 h-3 shrink-0 ml-1 fill-current text-gray-400 dark:text-gray-500 <?php if(in_array(Request::segment(1), ['settings'])): ?><?php echo e('rotate-180'); ?><?php endif; ?>" :class="open ? 'rotate-180' : 'rotate-0'" viewBox="0 0 12 12">
                                        <path d="M5.9 11.4L.5 6l1.4-1.4 4 4 4-4L11.3 6z" />
                                    </svg>
                                </div>
                            </div>
                    ...
                    <!-- Utility -->
                    <li class="pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-[linear-gradient(135deg,var(--tw-gradient-stops))] <?php if(in_array(Request::segment(1), ['utility'])): ?><?php echo e('from-violet-500/[0.12] dark:from-violet-500/[0.24] to-violet-500/[0.04]'); ?><?php endif; ?>" x-data="{ open: <?php echo e(in_array(Request::segment(1), ['utility']) ? 1 : 0); ?> }">
                        <a class="block text-gray-800 dark:text-gray-100 truncate transition <?php if(!in_array(Request::segment(1), ['utility'])): ?><?php echo e('hover:text-gray-900 dark:hover:text-white'); ?><?php endif; ?>" href="#0" @click.prevent="open = !open; sidebarExpanded = true">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    <svg class="shrink-0 fill-current <?php if(in_array(Request::segment(1), ['utility'])): ?><?php echo e('text-violet-500'); ?><?php else: ?><?php echo e('text-gray-400 dark:text-gray-500'); ?><?php endif; ?>" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                                ...
                                <!-- Icon -->
                                <div class="flex shrink-0 ml-2 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                                    <svg class="w-3 h-3 shrink-0 ml-1 fill-current text-gray-400 dark:text-gray-500 <?php if(in_array(Request::segment(1), ['utility'])): ?><?php echo e('rotate-180'); ?><?php endif; ?>" :class="open ? 'rotate-180' : 'rotate-0'" viewBox="0 0 12 12">
                                        <path d="M5.9 11.4L.5 6l1.4-1.4 4 4 4-4L11.3 6z" />
                                    </svg>
                                </div>
                            </div>
