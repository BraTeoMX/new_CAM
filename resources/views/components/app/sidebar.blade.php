<div class="min-w-fit">
    ...
    <aside id="sidebar"
        ...
        <!-- Expand/collapse button (always top, only on lg+) -->
        <div class="hidden lg:block">
            <button
                class="p-2 rounded-full text-gray-400 hover:text-gray-500 dark:text-gray-500 dark:hover:text-gray-400 transition-colors"
                @click="
                        ...
                        <div class="pl-4 pr-3 py-2 rounded-lg">
                            <button type="button"
                                ...
                                <span class="flex items-center">
                                    ...
                                    <span
                                        class="text-sm font-medium ml-4 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Configuraciones</span>
                                </span>
                            ...
                            <ul x-show="open" class="pl-8 pr-3 py-2 space-y-2">
                                <li class="rounded-lg">
                                    <a class="flex items-center text-gray-500/90 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 transition truncate pl-4 pr-3 py-2
                                        ...
                                        <span
                                            class="text-sm font-medium ml-4 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Administrar
                                            Usuarios</span>
                                    </a>
                                </li>
                                <li class="rounded-lg">
                                    <a class="flex items-center text-gray-500/90 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 transition truncate pl-4 pr-3 py-2
                                                @if (Request::segment(1) === 'vinculacion') bg-[linear-gradient(135deg,var(--tw-gradient-stops))] from-violet-500/[0.12] dark:from-violet-500/[0.24] to-violet-500/[0.04] @endif"
                                        href="{{ route('vinculacion.index') }}">
                                        <span class="material-symbols-outlined">library_books</span>
                                        <span
                                            class="text-sm font-medium ml-4 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Vinculaciones</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
                ...
                <ul class="space-y-2">
                    ...
                    <li>
                        <a class="flex items-center pl-4 pr-3 py-2 rounded-lg
                            ...
                            href="{{ route('reasignacionManual.index') }}">
                            <span class="material-symbols-outlined">person_alert</span>
                            <span
                                class="text-sm font-medium ml-4 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Reasignación
                                Manual</span>
                        </a>
                    </li>
                    @endif
                    ...
                    <li x-data="{ open: {{ in_array(Request::segment(1), ['Documentar', 'FormOTMeca']) ? 1 : 0 }} }">
                        <div class="pl-4 pr-3 py-2 rounded-lg">
                            ...
                            <ul x-show="open" class="pl-8 pr-3 py-2 space-y-2">
                                ...
                                <li class="rounded-lg">
                                    <a class="flex items-center text-gray-800 dark:text-gray-100 truncate transition pl-4 pr-3 py-2
                                            @if (Request::segment(1) === 'reporte') bg-[linear-gradient(135deg,var(--tw-gradient-stops))] from-violet-500/[0.12] dark:from-violet-500/[0.24] to-violet-500/[0.04] @endif"
                                        href="{{ route('reporte.diario') }}">
