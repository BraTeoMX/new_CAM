<x-app-layout>
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-8">
            <h3 class="text-2xl md:text-3xl text-gray-800 dark:text-gray-100 font-bold">Vinculacion Area/Modulo -
                Mecanico</h3>
        </div>

        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
            <div>
                <label for="select-supervisor" class="block font-medium mb-1">Area/Modulo</label>
        ...
        <div class="mt-4">
            <button id="btn-anadir-vinculacion"
                class="bg-green-600 text-white px-4 py-2 rounded hover:bg-green-700 disabled:opacity-50" disabled>
                Añadir a lista
            </button>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 shadow-lg rounded-lg p-6 mt-8">
            <h2 class="text-xl font-bold mb-4 text-gray-800 dark:text-white">Vinculación Area/Modulo - Mecánico
            </h2>
            <div class="overflow-x-auto">
                <table class="min-w-full table-fixed divide-y divide-gray-200 dark:divide-gray-700"
                    id="tabla-vinculacion">
