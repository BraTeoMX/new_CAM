    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div class="w-full my-1 mx-auto px-2 sm:px-4 md:px-6 lg:px-8 flex flex-col space-y-4">
                <div class="flex text-2xl font-medium tracking-tight text-gray-950 dark:text-white">Conteo de status de tickets</div>
                ...
                <div id="dashboard-heatmap"
                    ...
                    <div class="heatmap-container overflow-x-auto pb-4">
                        <div class="min-h-[280px] flex items-center justify-center">
                            <div class="animate-pulse text-gray-400">Cargando actividad...</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        {{-- ...existing code... --}}
        @vite(['resources/js/elemento1dashboard.js', 'resources/js/dashboardHeatmap.js'])
    </div>
</x-app-layout>
