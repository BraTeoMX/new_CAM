import{P as u,E as g}from"./pusher-RuRbGOpv.js";import"./_commonjsHelpers-Cpj98o6Y.js";window.Pusher=u;window.Echo=new g({broadcaster:"pusher",key:"51d9687d2d0bffce329a",cluster:"us3",forceTLS:!0,encrypted:!0});function m(e){switch(e){case"FINALIZADO":return"bg-blue-800 text-blue-100";case"ASIGNADO":return"bg-blue-100 text-blue-800";case"PROCESO":return"bg-yellow-100 text-yellow-800";case"PENDIENTE":return"bg-red-100 text-red-800";case"ATENDIDO":return"bg-green-100 text-green-800";default:return"bg-gray-100 text-gray-800"}}function b(e){switch(e){case"FINALIZADO":return"ring-blue-600 dark:ring-blue-600 bg-blue-600";case"ASIGNADO":return"ring-blue-400 dark:ring-blue-400 bg-blue-400";case"PROCESO":return"ring-yellow-400 dark:ring-yellow-400 bg-yellow-400";case"PENDIENTE":return"ring-red-500 dark:ring-red-500 bg-red-500";case"ATENDIDO":return"ring-green-600 dark:ring-green-600 bg-green-600";default:return"ring-gray-400 dark:ring-gray-400 bg-gray-400"}}function f(e){let n=e.foto?e.foto:"http://128.150.102.45:8000/Intimark/"+e.Num_Mecanico+".jpg";const s=m(e.Status),r=b(e.Status);return`
